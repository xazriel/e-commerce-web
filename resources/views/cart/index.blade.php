        ...
        @if(session('cart') && count(session('cart')) > 0)
                ...
                @foreach(session('cart') as $id => $details)
                    ...
                    <div class="flex items-start gap-8 py-6 border-b border-gray-50 last:border-0">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-[11px] text-gray-400 mb-2">Default Style</p>
                            ...
                            <div class="mt-6 flex items-center justify-end gap-6">
                                ...
                                <div class="flex items-center border border-gray-200 rounded-sm">
                                    <button class="px-3 py-1 text-gray-400 hover:text-black">-</button>
                                    <span class="px-3 py-1 text-[11px] font-bold">{{ $details['quantity'] }}</span>
                                    <button class="px-3 py-1 text-gray-400 hover:text-black">+</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-8 flex flex-col items-end gap-6">
                ...
                <div class="w-full sm:w-1/3">
                    <a href="#" class="block w-full bg-[#6B6631] text-white text-center py-4 text-[10px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-[#5A5629] transition shadow-md flex items-center justify-center gap-2">
