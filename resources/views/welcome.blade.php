...
<head>
    ...
    <!-- Alpine.js untuk menangani Modal Pop-up secara ringan -->
...
<body class="antialiased bg-white text-gray-900" x-data="{ openModal: null }">
    ...
    <div id="search-overlay" class="fixed inset-0 z-[100] bg-black/60 items-center justify-center p-4">
        <div class="bg-white w-full max-w-2xl p-6 rounded-sm shadow-2xl animate-fade-in-down">
            ...
            <input type="text" id="search-input" placeholder="TYPE TO SEARCH..." class="w-full border-b border-gray-200 py-3 text-sm tracking-widest focus:outline-none focus:border-black uppercase">
                ...
                @forelse($sliders as $slider)
                    ...
                    <div class="swiper-slide relative {{ !$hasMobile && !$hasVideo ? 'desktop-only' : '' }} {{ !$hasDesktop && !$hasVideo ? 'mobile-only' : '' }}">
                        ...
                        <div class="absolute inset-0 z-10 flex flex-col items-center justify-center text-center text-white px-4">
                            <h2 class="text-xs tracking-[0.6em] uppercase mb-6">
                                {{ $slider->title }}
                            </h2>
                            <h1 class="text-5xl md:text-6xl font-extralight tracking-widest uppercase mb-8">
                                Koleksi Eksklusif
                            </h1>
                            <a href="#koleksi" class="mt-10 inline-block px-10 py-4 border border-[#6B7D5C] text-[10px] tracking-[0.4em] uppercase text-white hover:bg-[#6B7D5C] transition duration-500">
                                Shop Now
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-16 text-left">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-[11px] tracking-widest uppercase text-white/80">
                        <li>
                            <button @click="openModal = 'contact'" class="hover:text-white transition">Contact Us</button>
                        </li>
                        <li>
                            <button @click="openModal = 'shipping'" class="hover:text-white transition">Shipping & Returns</button>
                        </li>
                        <li>
                            <button @click="openModal = 'howtobuy'" class="hover:text-white transition">How To Buy</button>
                        </li>
                        <li>
                            <button @click="openModal = 'faqs'" class="hover:text-white transition">FAQs</button>
                        </li>
                    </ul>
                </div>
